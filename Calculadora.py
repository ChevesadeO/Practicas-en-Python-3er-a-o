#Calculadora que le pregunte al usuario que desea hacer sea suma, resta, multiplicación, dar resultado y le pregunte si desea continuar si el usuario si desea continuar 
#s o no minúscula 
